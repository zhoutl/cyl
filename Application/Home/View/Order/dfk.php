                ...
                <div class="shoptop2 font-18">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="center pasxz3"><p class="password1-de">待发货</p></div>
                        </li>
                        <li>
                            <div class="password1-line5"></div>
                ...
                <div class="width">
                    ...
                    <div class="account2">
                       <div class="wb65 f_l ml32">
                           <div class="font-24 red">待付款</div>
                           <div class="c999 mt15">物流追踪（暂无）</div>
                       </div>
                       <div class="f_r mt15">
                           <a href="<?php echo U('Pay/index',array('orders_id'=>$data['list']['orders_id'])); ?>" class="btn-blue save font-20">去付款</a>
                       </div>
                    </div>
                </div>
                <!-- /当前订单状态 -->
