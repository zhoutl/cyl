    ...
    <div class="thewidth100 bg_gray clearfix"> 
        <div  class="thewidth">
            ...
            <div class="shopbox mt10">
                <div class="shoptop3 font-18">
                    <ul>
                        <li>
                            <div class="password1-line5 password1-line2"></div>
                            <div class="center pasxz4"><p class="password1-de current1">待付款</p></div>
                        </li>
                        <li>
                            <div class="password1-line5 password1-line2"></div>
                            <div class="center pasxz5"><p class="password1-de current1">交易关闭</p></div>
                        </li>
                    </ul>
                </div>
                <!-- 当前订单状态 -->
                <div class="width mt20">
                    ...
                    <div class="account2">
                       <div class="wb65 f_l ml32">
                           <div class="font-24 red">交易关闭</div>
                        </div>
                    </div>
                </div>
                <!-- /当前订单状态 -->
