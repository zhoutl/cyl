...
<script type="text/javascript" src="__PUBLIC__/Home/js/password/third.js"></script>
            ...
            <div class="password1 mt20 mb15">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="center pasxz"><p class="password1-first current1">3</p><p class="blue">重置密码</p></div>
                    </li>
                    <li>
                    ...
                    <form class="demoform">
                        <div class="demoformbox">
                            <div class="form-control lo_text">
                                <label class="wb30 f_l">新 密 码</label>
                                <input type="password" id="password" class="regkk1" name="newpassword" placeholder="由6-16位数字、字母下划线组成" datatype="/^[0-9a-zA-Z_]{6,16}$/" errormsg="请输入正确密码格式" nullmsg="请输入密码">
                            </div>
                        ...
                        <div class="demoformbox">
                            <div class="form-control lo_text">
                                ...
                                <input type="password" id="password2" class="regkk1" name="detepassword" recheck="newpassword" placeholder="请再次输入密码"  datatype="*" errormsg="您两次输入的账号密码不一致" nullmsg="请重新输入密码" >
                            </div>
                            <div class="Validform_checktip"></div>
                        </div>
                    
                        <div class="demoformbox">
                            <button type="button" id="LFSubmit2" id="btn_sub" class="btn btn-blue btn-lg font-16 mt10">确定</button>
                        </div>
