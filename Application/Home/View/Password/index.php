...
<script type="text/javascript" src="__PUBLIC__/Home/js/password/first.js"></script>
<script>
        ...
        <div class="bg_fff thewidth clearfix pb40">
            ...
            <div class="password1 mt20 mb15">
                <ul>
                    ...
                    <li>
                        <div class="password1-line"></div>
                        <div class="center pasxz"><p class="password1-first">2</p><p>验证身份</p></div>
                    </li>
                    <li>
                        <div class="password1-line"></div>
                    ...
                    <form method="post" class="demoform">
                        <div class="demoformbox">
                            <div class="form-control lo_text">
                                ...
                                <input type="text" id="username" class="regkk1" name="uname" placeholder="请输入手机号/邮箱" datatype="m|e" errormsg="请输入正确的手机号/邮箱" nullmsg="请输入手机号/邮箱">
                            </div>
                        ...
                        <div class="demoformbox pr">
                            <div class="form-control lo_text">
                                ...
                                <input type="text" id="imgCode" class="regkk1 regkk2" name="imgCode" altercss="gray" placeholder="请输入验证码" tip="请输入验证码" datatype="*4-6" errormsg="请输入4位验证码" nullmsg="请输入验证码">
                                <img class="regyzm" id="code_img" src="<?php echo U('Common/Verify') ?>" width="100" height="35" onclick="change_verify();" style="margin-top: -5px;height:41px;"/>
                            </div>
                            <div class="Validform_checktip"></div>
                        ...
                        <div class="demoformbox">
                            <div class="c5"><em class="gth ml10 mr10"></em>看不清？点击图片更换验证码</div>
