        ...
        <div class="bg_fff thewidth clearfix pb40">
            ...
            <div class="password1 mt20 mb25">
                <ul>
                    ...
                    <li>
                        <div class="center pasxz"><p class="password1-first current1">4</p><p  class="blue">完成</p></div>
                    </li>
                    
                </ul>
            </div>
            <div class="width center mt40">
                <em class="cg mr10"></em><span class="c666">恭喜您，密码修改成功！</span>
            </div>
            <div class="width center mt30">
                <span class="pass-mine font-16 mr17">
                   <a href="<?php echo U('Index/index') ?>">去逛逛</a>
                </span>
                <span class="pass-start font-16">
