...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">新增文章分类</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ /TITLE ]--------------->
            ...
            <div class="list_box">
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">新增文章分类</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Article/addArticleCategory'); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">分类名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="article_category_name" class="form-control the_text3 verify_text"  placeholder="请输入分类名称" errormsg="分类名称为1-10个字" nullmsg="请输入分类名称" datatype="*1-10"></td>
                      </tr>
                      <!-- <tr>
                        <td align="left" valign="top" class="aft_l">所属类别</td>
                        <td align="left" valign="middle" class="aft_r">
							<select class="form-control the_text3 verify_text" name="article_type" errormsg="请选择正确的所属类别" nullmsg="请选择所属类别" datatype="/^[1|2]{1}$/">
