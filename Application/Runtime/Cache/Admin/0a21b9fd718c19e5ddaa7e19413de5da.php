...
<body style="box-sizing: border-box; font: 14px 'Microsoft YaHei', '黑体', '宋体', Arial, Lucida Grande, Tahoma, sans-serif;">
    <div style="width:100%;text-align: center; padding:18% 0;">
        <div style="width:71px; height:67px; background:url(/cyl/Public/Admin/images/sb.jpg) no-repeat; background-size:100%; display:inline-block;"></div>
        <div style="font-size:2em; color:#333; line-height: 1.6em; margin-top:1.3em;"><?php echo ($error); ?>
        </div>
