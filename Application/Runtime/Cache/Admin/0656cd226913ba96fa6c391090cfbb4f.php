...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">新增管理员</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">新增管理员</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('AdminUser/addAdminUser'); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">用户名</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="account" class="form-control the_text3 verify_text"  placeholder="请输入用户名" errormsg="用户名由1-10位数字字母组成" nullmsg="请输入用户名" datatype="/^[0-9a-zA-Z]{1,10}$/"></td>
                      </tr>
                        ...
                        <td align="left" valign="middle" class="aft_r">
							<select class="form-control the_text3 verify_text" name="admin_role_id" errormsg="请选择所属角色" nullmsg="请选择所属角色" datatype="/^[1-9][0-9]{0,}$/">
								...
								<?php foreach($data['admin_role_list'] as $k=>$v){ ?>
									<option value="<?php echo $v['admin_role_id']; ?>"><?php echo $v['role_name']; ?></option>
								<?php } ?>
                            </select>
						</td>
                      </tr>
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="real_name" class="form-control the_text3 verify_text"  placeholder="请输入真实姓名" errormsg="真实姓名为1-20个字" nullmsg="请输入真实姓名" datatype="*1-20" ignore="ignore"></td>
                      </tr>
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="email" class="form-control the_text3 verify_text"  placeholder="请输入邮箱" errormsg="请输入正确格式的邮箱" nullmsg="请输入邮箱" datatype="e" ignore="ignore"></td>
                      </tr>
					  
					  <tr>
                        <td align="left" valign="top" class="aft_l">手机号</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="telphone" class="form-control the_text3 verify_text"  placeholder="请输入手机号码" errormsg="请输入正确格式的手机号码" nullmsg="请输入手机号码" datatype="m" ignore="ignore"></td>
                      </tr>
