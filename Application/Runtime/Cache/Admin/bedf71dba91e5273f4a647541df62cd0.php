...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改BANNER</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ /TITLE ]--------------->
            ...
            <div class="list_box">
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">修改BANNER</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Home/editBanner',array('id'=>$data['list']['banner_id'])); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="name" value="<?php echo $data['list']['name'] ;?>" class="form-control the_text3 verify_text"  placeholder="请输入BANNER名称" errormsg="BANNER名称为1-20个字" nullmsg="请输入BANNER名称" datatype="*1-20"></td>
                      </tr>
						...
						<select class="form-control the_text2 f_l" name="type" nullmsg="请选择所属版本" errormsg="请选择所属版本" datatype="/^[1-9][0-9]{0,}$/">
							...
							<option value="1" <?php echo $data['list']['type']==1?'selected':'';?>>PC版本</option>
							<option value="2" <?php echo $data['list']['type']==2?'selected':'';?> >WAP版本</option>
							<option value="3" <?php echo $data['list']['type']==3?'selected':'';?> >APP版本</option>
						</select>
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="link_url" value="<?php echo $data['list']['link_url'] ;?>" class="form-control the_text3 verify_text"   placeholder="请输入链接地址" errormsg="请输入正确格式的链接地址" nullmsg="请输入链接地址" datatype="url" ignore="ignore"></td>
                      </tr>
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r" id="file_img">
							<img src="<?php echo $data['list']['img_uri'] ;?>" width="576" height="324" />
						</td>
                      </tr>
					...
					<input type="hidden" name="img_uri" value="<?php echo $data['list']['img_uri'] ;?>" />
