...
<link rel="stylesheet" href="__PUBLIC__/Admin/css/style_new.css" />
...
<script src="__PUBLIC__/Common/js/laydate/laydate.js"></script>


  <!--dashboard-->
<script type="text/javascript" src="__PUBLIC__/Admin/src/highcharts/highcharts.js"></script>
<script type="text/javascript" src="__PUBLIC__/Admin/src/highcharts/exporting.js"></script>
...
<div class="">
    ...
    <div class="top_fixed_head clearfix">
        <div class="logo f_l"><h3>车优里管理平台</h3></div>
        <div class="top_right f_r clearfix">
            <ul>
                <li><a href="<?php echo U('Home/Index/index'); ?>" data-toggle="tooltip" data-placement="bottom" title="前台浏览"><i class="icon-desktop"></i></a></li>
