...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改会员等级</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">修改会员等级</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Account/editAccountLevel',array('id'=>$data['list']['account_level_id'])); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">会员等级名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="name" value="<?php echo $data['list']['name']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入会员等级名称" errormsg="会员等级名称为1-10个字" nullmsg="请输入会员等级名称" datatype="*1-10"></td>
                      </tr>
        
                      <tr>
                        <td align="left" valign="top" class="aft_l">最低成长值</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="conditions" value="<?php echo $data['list']['conditions']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入最低成长值" errormsg="请输入数字" nullmsg="请输入最低成长值" datatype="n"></td>
                      </tr>
					  
					  <tr>
                        <td align="left" valign="top" class="aft_l">备注</td>
                        <td align="left" valign="middle" class="aft_r">
							<textarea class="form-control the_text3 verify_text" rows="5" name="mark" placeholder="请输入备注" errormsg="备注为1-200个字" nullmsg="请输入备注" datatype="*1-200" ignore="ignore"><?php echo $data['list']['mark']; ?></textarea>
						</td>
                      </tr>
