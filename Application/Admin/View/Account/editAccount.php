...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改会员</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">修改会员</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Account/editAccount',array('id'=>$data['list']['account_id'])); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">邮箱号</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="email" value="<?php echo $data['list']['email']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入邮箱号" errormsg="请输入正确格式的邮箱" nullmsg="请输入邮箱号" datatype="e" ignore="ignore"></td>
                      </tr>
        
                      <tr>
                        <td align="left" valign="top" class="aft_l">手机号</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="mobile" value="<?php echo $data['list']['mobile']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入手机号" errormsg="请输入正确格式的手机号" nullmsg="请输入手机号" datatype="m" ignore="ignore"></td>
                      </tr>
