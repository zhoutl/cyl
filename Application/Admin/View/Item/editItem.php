...
<script>
	...
	var item_id = "<?php echo $data['list']['item_id']; ?>";
	...
	function ajax_set_first_img(obj,img_id){
		var obj = $(obj);
		var url = "<?php echo U('Item/setDefaultImage'); ?>";
		$.post(url, {item_id:item_id,img_id:img_id}, function (data) { 
			if(data.status){
				$("span[name=icon-picture]").remove();
				obj.after('<span name="icon-picture" style="margin-left:2px;"><button type="button" class="btn btn-info btn-xs"><i class="icon-picture"></i></button></span>');
			}else{
	...
	function del_item_img(obj,img_id){
		var img_id = img_id;
		var obj = $(obj);
		var url = "<?php echo U('Item/delItemImage'); ?>";
		
		layer.confirm('确定要删除此图片？', {
			btn: ['确定','取消'] //按钮
			}, function(){
				$.post(url, {img_id: img_id }, function (data) { 
					if(data.status){
						obj.parent().parent().parent().remove();
						layer.alert(data.msg);
					}else{
        ...
        <td class="main_table_right" align="left" valign="top">
            <div id="Right">
                <div class="page_right_header">
                    <div class="f_l">
                        <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改商品</span></h4>
                    </div>
                    <div class="f_r">
                ...
                <div class="page_right_bodyer">
                    <div class="list_box">
                        <div class="ja_add_tab">
                            ...
                            <form action="<?php echo U('Item/editItem',array('id'=>$data['list']['item_id'])); ?>" method="post" id="adminForm">
                                <div class="tab-content">
									   ...
									   <tr>
                                        ...
                                        <select class="form-control the_text2 f_l" name="item_category_id" nullmsg="请选择商品分类" errormsg="请选择商品分类" datatype="/^[1-9][0-9]{0,}$/">
										  <?php foreach($data['category_list'] as $v): ?>
											<option value="<?php echo $v['item_category_id']; ?>" <?php if($data['list']['item_category_id'] == $v['item_category_id']){echo 'selected';} ?>><?php echo $v['category_name']; ?></option>
										  <?php endforeach; ?>
                                        </select>
                                      ...
                                      <tr>
                                        ...
                                        <select class="form-control the_text2 f_l" name="brand_id" nullmsg="请选择商品品牌" errormsg="请选择商品品牌" datatype="/^[1-9][0-9]{0,}$/">
										  <?php foreach($data['brand_list'] as $v): ?>
											<option value="<?php echo $v['brand_id'] ?>" <?php if($data['list']['brand_id'] == $v['brand_id']){echo 'selected';} ?>><?php echo $v['brand_name']; ?></option>
										  <?php endforeach; ?>
                                        </select>
                                        </td>
                                      </tr>
									...
									<tr>
                                        ...
                                        <select class="form-control the_text2 f_l" name="item_purpose_id" nullmsg="请选择商品用途" errormsg="请选择商品用途" datatype="/^[1-9][0-9]{0,}$/">
										  ...
										  <?php foreach($data['purpose_list'] as $v): ?>
											<option value="<?php echo $v['item_purpose_id'] ?>" <?php if($data['list']['item_purpose_id'] == $v['item_purpose_id']){echo 'selected';} ?>><?php echo $v['purpose_name']; ?></option>
										  <?php endforeach; ?>
                                        </select>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="artno" value="<?php echo $data['list']['artno']; ?>" class="form-control the_text2 verify_text" placeholder="请输入商品货号" datatype="*1-30" nullmsg="请输入商品货号" errormsg="商品货号为1-30个字"></td>
                                      </tr>

									  
                                       <tr>
                                        <td align="left" valign="top" class="aft_l">商品名称</td>
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="name" value="<?php echo $data['list']['name']; ?>" class="form-control the_text6 verify_text"  placeholder="请输入商品名称" datatype="*1-80" nullmsg="请输入商品名称" errormsg="商品名称为1-30个字"></td>
                                      </tr>
									  
									  <tr>
                                        <td align="left" valign="top" class="aft_l">换算数量</td>
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="conversion_num" value="<?php echo $data['list']['conversion_num']; ?>" value="1" class="form-control the_text2 verify_text" placeholder="请输入换算数量" datatype="n" nullmsg="请输入换算数量" errormsg="请填写数字"></td>
                                      </tr>
                                       
                                      <tr>
                                        <td align="left" valign="top" class="aft_l">门店价</td>
                                        <td align="left" valign="middle" class="aft_r">                        
                                          <input type="text" name="shop_price" value="<?php echo $data['Item_spec_price']['shop_price']; ?>"  class="form-control the_text2 verify_text" placeholder="请输入商品门店价" datatype="f2" nullmsg="请输入商品门店价" errormsg="请输入正确的价格">元               
                                        </td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td align="left" valign="middle" class="aft_r">                        
                                          <input type="text" name="online_price" value="<?php echo $data['Item_spec_price']['online_price']; ?>" class="form-control the_text2 verify_text" placeholder="请输入商品商城价" datatype="f2" nullmsg="请输入商品商城价" errormsg="请输入正确格式的价格">元                   
                                        </td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td align="left" valign="middle" class="aft_r">                        
                                          ...
                                          <input type="text" name="app_price" value="<?php echo $data['Item_spec_price']['app_price']; ?>" class="form-control the_text2 verify_text" placeholder="请输入商品APP专享价"  datatype="f2" nullmsg="请输入APP专享价" errormsg="请输入正确格式的价格">元
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="stock" value="<?php echo $data['Item_spec_price']['stock']; ?>" class="form-control the_text2 verify_text" placeholder="请输入库存数量" datatype="n" nullmsg="请输入库存数量" errormsg="请输入正确格式的数量"></td>
                                      </tr>
                                      <tr>
                                        <td align="left" valign="top" class="aft_l">商品简称</td>
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="short_name" value="<?php echo $data['list']['short_name']; ?>" class="form-control the_text6 verify_text"  placeholder="请输入商品简称" ignore="ignore" datatype="*1-40" nullmsg="请输入商品简称" errormsg="商品简称为1-40个字"></td>
                                      </tr>
                                      <tr>
                                        <td align="left" valign="top" class="aft_l">商品副标题</td>
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="subheading" value="<?php echo $data['list']['subheading']; ?>" class="form-control the_text6 verify_text"  placeholder="请输入商品副标题" ignore="ignore" datatype="*1-50" nullmsg="请输入商品副标题" errormsg="商品副标题为1-50个字"></td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td align="left" valign="middle" class="aft_r"><input type="text" name="tags" value="<?php echo $data['list']['tag']; ?>" class="form-control the_text6 verify_text"  placeholder="多个标签以;(英文分号)相隔开" datatype="*" ignore="ignore" nullmsg="请输入商品标签" errormsg="请输入商品标签"></td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <input type="radio" name="is_on_sale" value="1" <?php if($data['list']['is_on_sale'] == '1'){echo 'checked="checked"';} ?> >
                                        是
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="is_on_sale" value="0" <?php if($data['list']['is_on_sale'] == '0'){echo 'checked="checked"';} ?> >
                                        否
                                        </label>
                                  ...
                                  <!--details-->
                                   <div class="tab-pane" id="details">
                                      ...
                                      <script id="description" name="description" type="text/plain" style="width:1024px;height:500px;"><?php echo htmlspecialchars_decode($data['item_detail']); ?></script>   
                                  </div>
                                         
                                  <!--attribute-->
                                  <div class="tab-pane" id="attribute">
                                      <?php W('Admin/itemAttributeInfo',array(array('attribute_list'=>$data['attribute_list'],'item_extra_list'=>$data['item_extra_list'])));?>
                                  ...
                                  <div class="tab-pane" id="thumbnail">
                                    ...
                                    <div class="list_box">
                                    	...
                                    	<?php if(!empty($data['item_image_list'])): foreach ($data['item_image_list'] as $ival):?>
										 <div class="pro_box">
											<div class="pro_box_img"><img src="<?php echo $ival['img_uri']?>"></div>
											<div class="pro_box_btn">
											<div class="f_r">
											<button type="button" class="btn btn-success btn-xs" onclick="ajax_set_first_img(this,'<?php echo $ival['item_image_id']?>');"><i class="icon-ok-sign">设为封面</i></button>
											<?php if($ival['is_default'] == 1){ ?>
											<span name="icon-picture" style="margin-left:2px;"><button type="button" class="btn btn-info btn-xs"><i class="icon-picture"></i></button></span>
											<?php } ?>
											<button type="button" class="btn btn-danger btn-xs" onclick="del_item_img(this,'<?php echo $ival['item_image_id']?>');"><i class="icon-remove">删除</i></button>
											</div>
											</div>
										</div>
