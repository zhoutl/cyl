...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">新增属性</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">新增属性</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Item/addItemCategoryAttribute'); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">属性名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="attribute_name" class="form-control the_text3 verify_text"  placeholder="请输入属性名称" errormsg="属性名称为1-20个字" nullmsg="请输入属性名称" datatype="*1-20"></td>
                      </tr>
					  
					  <tr>
                        <td align="left" valign="top" class="aft_l">所属分类</td>
                        <td align="left" valign="middle" class="aft_r">
							<select class="form-control the_text3 verify_text" name="item_category_id" errormsg="请选择所属分类" nullmsg="请选择所属分类" datatype="/^[1-9][0-9]{0,}$/">
								<option value="0">请选择所属分类</option>
								<?php foreach($data['item_category_list'] as $k=>$v){ ?>
					  ...
					  <tr>
						...
						<td align="left" valign="middle" class="aft_r">
							<label class="radio-inline"><input type="radio" name="is_filter" value="1" checked />是</label>
							<label class="radio-inline"><input type="radio" name="is_filter" value="0" />否</label>
						</td>
                      </tr>
