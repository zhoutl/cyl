      ...
      <tr>
        ...
        <div id="Right">
            ...
            <div class="page_right_menu the_highlighted2 clearfix">
				<div class="dropdown">
                  <a class="btn btn-default dropdown-toggle" href="<?php echo U('Item/addBrand'); ?>">
            ...
            <div class="list_box">
                ...
                <tbody>
                  ...
                  <tr name="data_<?php echo $v['brand_id']; ?>">
                    <td valign="middle" align="center"><?php echo $v['brand_name']; ?></td>
                    <td valign="middle" align="center"><?php echo $v['orderno']; ?></td>
                    <td valign="middle" align="center" class="td_w_link">
                        <a href="<?php echo U('Item/editBrand',array('id'=>$v['brand_id'])); ?>" class="btn btn-primary btn-xs"><i class="icon-edit"></i>&nbsp;编辑</a>
                        <a href="javascript:void(0);" onclick="delete_data('<?php echo $v['brand_id']; ?>','<?php echo U('Item/delBrand'); ?>')" class="btn btn-danger btn-xs del_button"><i class="icon-remove"></i>&nbsp;&nbsp;删除</a>
                    </td>
                  </tr>
				  <?php endforeach; ?>
