        ...
        <div id="Right">
            ...
            <div class="page_right_bodyer">
				...
				<div class="list_heads mb20 clearfix">
					<form method="get" action="<?php echo U('Item/recycleItemList'); ?>">
                ...
                <tbody>
                  ...
                  <tr name="data_<?php echo $v['item_id']; ?>">
                    ...
                    <td valign="middle" align="center" class="td_w_link">
						<a href="javascript:void(0);" onclick="delete_data('<?php echo $v['item_id']; ?>','<?php echo U('Item/recoveryItem'); ?>')" class="btn btn-success btn-xs reply_button"><i class="icon-reply"></i>恢复商品</a>
						<a href="javascript:void(0);" onclick="delete_data('<?php echo $v['item_id']; ?>','<?php echo U('Item/delItem'); ?>')" class="btn btn-danger btn-xs del_button"><i class="icon-remove"></i>彻底删除</button>
					</td>
                  </tr>
				  <?php endforeach; ?>
