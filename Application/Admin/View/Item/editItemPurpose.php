...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改用途</span></h4>
                </div>
                <div class="f_r">
                	<a class="btn btn-success" href="<?php echo U('Item/itemPurposeList') ?>"><i class="icon-reorder"></i> &nbsp; 管理列表</a>
                </div>
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">修改用途</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Item/editItemPurpose',array('id'=>$data['list']['item_purpose_id'])); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">用途名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="purpose_name" value="<?php echo $data['list']['purpose_name'];  ?>" class="form-control the_text3 verify_text"  placeholder="请输入用途名称" errormsg="用途名称为1-20个字" nullmsg="请输入用途名称" datatype="*1-20"></td>
                      </tr>
