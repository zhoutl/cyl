...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">新增订单满减</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">新增订单满减</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('Promotion/addOrdersReduction'); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">活动名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="name" class="form-control the_text3 verify_text"  placeholder="请输入活动名称" errormsg="活动名称为1-20个字" nullmsg="请输入活动名称" datatype="*1-20"></td>
                      </tr>
                      <tr>
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="limit_orders_amount" class="form-control the_text3 verify_text"  placeholder="请输入满额条件" errormsg="请输入正确的金额" nullmsg="请输入满额条件" datatype="f2">元</td>
                      </tr>
					  
					  <tr>
                        <td align="left" valign="top" class="aft_l">优惠金额</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="reduction_amount" class="form-control the_text3 verify_text"  placeholder="请输入优惠金额" errormsg="请输入正确的金额" nullmsg="请输入优惠金额" datatype="f2">元</td>
                      </tr>
