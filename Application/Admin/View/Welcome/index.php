...
<script type="text/javascript" src="__PUBLIC__/Common/js/echarts-all.js"></script>
<!-- 统计报表 -->
<div class="row mb20">
      ...
      <div class="count_body clearfix">
        ...
        <div id="NewComm" class="dash_box2">
          ...
          <div class="commlooop clearfix">
            <div class="commlooop_face"><a href="#"><img src="__PUBLIC__/Admin/images/test/face<?php echo $i;?>.jpg"></a></div>
