...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">新增配送</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">新增配送</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('System/addDeliveryMode'); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">配送名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="name" class="form-control the_text3 verify_text"  placeholder="请输入配送名称" errormsg="配送名称为1-20个字" nullmsg="请输入配送名称" datatype="*1-20"></td>
                      </tr>
					  <tr>
                        <td align="left" valign="top" class="aft_l">配送描述</td>
                        <td align="left" valign="middle" class="aft_r">
							<textarea class="form-control the_text3 verify_text" rows="5" name="description" placeholder="请输入配送描述" errormsg="配送描述为1-200个字" nullmsg="请输入配送描述" datatype="*1-200" ignore="ignore"></textarea>
						</td>
                      </tr>
