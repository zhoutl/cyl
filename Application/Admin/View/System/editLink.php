...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title">修改友情链接</span></h4>
                </div>
                <div class="f_r">
...
<!---------------[ BODY ]--------------->
                ...
                <div class="ja_add_from mb20">
                	<div class="add_from_head">修改友情链接</div>
                	<div class="add_from_body">
                    <form action="<?php echo U('System/editLink',array('id'=>$data['list']['link_id'])); ?>" method="post" id="adminForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="add_from_table">
                      <tr>
                        <td align="left" valign="top" class="aft_l">链接名称</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="link_name" value="<?php echo $data['list']['link_name']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入链接名称" errormsg="链接名称为1-20个字" nullmsg="请输入链接名称" datatype="*1-20"></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" class="aft_l">链接地址</td>
                        <td align="left" valign="middle" class="aft_r"><input type="text" name="link_url" value="<?php echo $data['list']['link_url']; ?>" class="form-control the_text3 verify_text"  placeholder="请输入链接地址" errormsg="请输入链接地址" nullmsg="请输入链接地址" datatype="url"></td>
                      </tr>
