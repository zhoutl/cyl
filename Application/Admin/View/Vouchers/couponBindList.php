...
<!---------------[ TITLE ]--------------->
                ...
                <div class="f_l">
                    <h4><i class="icon-bar-chart"></i> &nbsp; <span id="page_title"><?php echo $data['coupon_name']; ?> 优惠券领取详情</span></h4>
                </div>
                <div class="f_r">
                	<a class="btn btn-success" href="javascript:window.history.go(-1);"><i class="icon-reorder"></i> &nbsp; 返回优惠券列表</a>
                </div>
...
<!---------------[ /TITLE ]--------------->
            ...
            <div class="list_box">
                ...
                <thead>
                  <tr>
					<th scope="col" class="">领取人ID</th>
                    <th scope="col" class="">领取人邮箱</th>
                    <th scope="col" class="">领取人手机</th>
					<th scope="col" class="th_w7">领取时间</th>
                ...
                <tbody>
                  ...
                  <tr name="data_<?php echo $v['coupon_bind_id']; ?>">
                    <td valign="middle" align="center"><?php echo $v['account_id']; ?></td>
                    <td valign="middle" align="center"><?php echo M('Account')->where('account_id='.$v['account_id'])->getField('email'); ?></td>
                    <td valign="middle" align="center"><?php echo M('Account')->where('account_id='.$v['account_id'])->getField('mobile'); ?></td>
					<td valign="middle" align="center"><?php echo date("Y-m-d H:i:s",$v['bind_time']); ?></td>
